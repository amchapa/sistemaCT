...
if(isset($_POST['_total1'])){
    ...
    if($Model_Presupuesto->actualizarDatosPrecios($code,$total1,$total2,$total3,$total4,$total5,$rango1,$rango2,$rango3,$rango4 ,$precios1,$precios2,$precios3,$precios4,$precios5,$precios6,$precios7,$precios8,$precios9)){                        
        $msg = array(
            "response" => 1,
