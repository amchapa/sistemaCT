...
if(isset($_POST['_codigo'])){
    ...
    if($Model_Orden->registrarDetAcabado($codigo,$doblez,$compaginado,$encolado,$barniz,$plastificado,$pegado,$corteFinal,$refilado,$troquelado,$numerado,$perforado,$fajillado,$alce,$contado,$contraplacado,$otros1,$otros2,$otros3)){                        
        $msg = array(
            "response" => 1,
