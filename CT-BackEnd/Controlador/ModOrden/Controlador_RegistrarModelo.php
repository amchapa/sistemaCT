...
if(isset($_POST['_codigo']) && isset($_POST['_tamañoPliego']) && isset($_POST['_numeroPliego']) && isset($_POST['_numeroPlaca']) && isset($_POST['_pinza'])){
    ...
    if($Model_Orden->registrarModelo($codigo,$tamanoPliego,$numeroPliego,$numeroPlaca,$pinza,$imagen1,$imagen2,$indicaciones)){                        
        $msg = array(
            "response" => 1,
