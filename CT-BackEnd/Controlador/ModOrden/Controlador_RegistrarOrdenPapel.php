...
if(isset($_POST['_codigo'])){
    ...
    if($Model_Orden->registrarOrdenPapel($codigo,$material1,$gramos1,$hojaResma1,$medidaResma1,$medidaCorte1,$pliegoHoja1,$panneau1,$material2,$gramos2,$hojaResma2,$medidaResma2,$medidaCorte2,$pliegoHoja2,$panneau2,$material3,$gramos3,$hojaResma3,$medidaResma3,$medidaCorte3,$pliegoHoja3,$panneau3)){                        
        $msg = array(
            "response" => 1,
