...
if(isset($_POST['_codigo'])){
    ...
    if($Model_Orden->registrarEmpaquetado($codigo,$tipo,$catnEmpaq1,$catnEmpaq2,$catnEmpaq3,$catnEmpaq4,$catnEmpaq5,$catnEmpaq6,$catnEmpaq7,$catnEmpaq8,$catnEmpaq9,$catnEmpaq10,$totalUnidades)){                        
        $msg = array(
            "response" => 1,
