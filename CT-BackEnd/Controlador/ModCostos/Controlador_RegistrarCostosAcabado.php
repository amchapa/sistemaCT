...
if(isset($_POST['_controlinsumo'])){
    ...
    if($Model_Costos->registrarCostosAcabado($controlinsumo,$itemnumero,$fecharegistro,$acabado,$personal,$fechainicio,$fechafinal,$horainicio,$horafinal,$observaciones,$costo,$usuario)){                        
        $msg = array(
            "response" => 2,
