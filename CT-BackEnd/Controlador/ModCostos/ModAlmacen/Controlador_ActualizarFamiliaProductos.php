...
if(isset($_POST['_codigo'])){
    ...
    if($Model_Costos->actualizarFamiliaProductos($codigo,$nombre,$fecha,$estado,$usuario)){                        
        $msg =$Model_Costos->actualizarFamiliaProductos($codigo,$nombre,$fecha,$estado,$usuario);                        
